# DevMentor Brasil - App Aluguel Carros
...
**Para fazer este desafio, você pode escolher sua tecnologia favorita e seguir sem problemas.**

## Desafio
 
Seu desafio é construir essa interface de um App para aluguel de carros onde deve ter 3 telas, primeira inicial de boas vindas, pagina home e detalhes de um carro.

O App pode ser com dados simbólicos com foco em recriar o mais fiel possível ao protótipo passado.

E fique tranquilo você pode criar esse desafio usando sua ferramenta favorita seja usando React Native, Flutter, Kotlin, Ionic... 

Quer algum apoio no desafio? [Junte-se à nossa comunidade](https://www.devmentor.com.br/comunidade) e faça perguntas no canal.

## Onde encontrar tudo

No site você baixou os arquivos iniciais para começar o projeto onde tem todos os assets necessários para o desenvolvimento do desafio.
